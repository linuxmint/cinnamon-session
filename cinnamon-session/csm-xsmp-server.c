...
#define CSM_XSMP_SERVER_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), CSM_TYPE_XSMP_SERVER, CsmXsmpServerPrivate))

struct CsmXsmpServerPrivate
{
                        ...
                        char         **failure_reason_ret)
{
        ...
        csm_store_add (server->priv->client_store, csm_client_peek_id (client), G_OBJECT (client));
...
csm_xsmp_server_class_init (CsmXsmpServerClass *klass)
{
        ...
        g_type_class_add_private (klass, sizeof (CsmXsmpServerPrivate));
}

static void
csm_xsmp_server_init (CsmXsmpServer *xsmp_server)
{
        xsmp_server->priv = CSM_XSMP_SERVER_GET_PRIVATE (xsmp_server);
